    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 text-sm mt-1">Manage renter information, insurance, and rental history</p>
        </div>
        <button onClick={() => setModal(true)} className="btn-primary whitespace-nowrap">
      ...
      {customers.length === 0 && (
        <div className="text-center py-12">
          <p className="text-slate-500">No customers found. Add one to get started.</p>
        </div>
      )}
